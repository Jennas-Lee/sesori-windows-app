    ...
    return (
        <div className="main-nav">
            <Nav className="flex-column">
                <BrowserRouter>
                    <NavItem>
                        <NavLink className="text-center text-body" to="/messenger" tag={RRNavLink}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-chat-left" viewBox="0 0 16 16">
                                <path
                                    d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                            </svg>
                            <p className="mt-1">메신저</p>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className="text-center text-body" to="/point" tag={RRNavLink}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <p className="mt-1">상벌점</p>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className="text-center text-body" to="/calendar" tag={RRNavLink}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <p className="mt-1">일정</p>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink className="text-center text-body" to="/timetable" tag={RRNavLink}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <p className="mt-1">시간표</p>
                        </NavLink>
                    </NavItem>
                    <NavItem className="setting-btn">
                        <NavLink className="text-center text-body" to="/settings" tag={RRNavLink}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
